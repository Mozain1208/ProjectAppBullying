...
<div class="grid lg:grid-cols-3 gap-8">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h3 class="font-bold text-gray-800 mb-4 border-b pb-2">Ubah Status</h3>
            <form action="{{ route('admin.report.status', $report->id) }}" method="POST" class="space-y-4">
                @csrf
                @method('PATCH')
                ...
                <button type="submit" class="w-full bg-gray-800 text-white py-2 rounded-lg font-bold text-sm hover:bg-gray-900 transition shadow-sm">
                    Simpan Perubahan
                </button>
            </form>
        </div>
